...
public interface SearchService {
	...
	// SearchAttractionResultDto attractionListBySidoGugun(int sidoCode, int
	// gugunCode); // 시도, 구군
	// SearchAttractionResultDto attractionListByContentTypeId(int contentTypeId);
	// // 분류코드
	// SearchAttractionResultDto attractionListBySidoContentTypeId(int sidoCode, int
	// contentTypeId); // 시도, 분류코드
	// SearchAttractionResultDto attractionListBySidoGugunContentTypeId(int
	// sidoCode, int gugunCode, int contentTypeId); // 시도, 구군, 분류코드
